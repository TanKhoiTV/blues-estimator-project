...
class BayesianLinearRegressionScratch:
    ...
    def fit(self, X: Any, y: Any) -> "BayesianLinearRegressionScratch":
        ...
        Augments features with a bias column, then computes the posterior
        precision matrix S^{-1} = alpha * I + beta * X^T X and posterior
        mean m = beta * S * X^T y.
...
class RandomForestRegressorScratch:
    ...
    def fit(self, X: Any, y: Any) -> "RandomForestRegressorScratch":
        ...
        of the training data to introduce variance reduction via bagging.
    ...
    def predict(self, X: Any) -> np.ndarray:
        ...
        Computes the mean prediction across all trees in the forest,
...
class AdvancedMethods:
    ...
    def plot_predictions_vs_actual(
        ...
        Trains all three models and renders a scatter plot of predicted against
        true target values, with a perfect-fit reference line included.
