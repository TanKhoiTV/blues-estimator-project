...
\textbf{Nhận xét}: Theo lý thuyết, ngưỡng cân nhắc điểm ảnh hưởng có thể tính bằng $4/n \approx 0.008$. Mặc dù có một vài quan sát nổi trội và vượt nhẹ qua ngưỡng này, nhưng xét theo tiêu chuẩn phổ biến của Cook (ngưỡng $0.5$ hoặc $1.0$), toàn bộ các điểm dữ liệu đều nằm sâu phía dưới. Vì vậy, có thể kết luận không có quan sát nào có ảnh hưởng nguy hiểm kết quả hồi quy.
